defmodule Adsb.Aircraft do
  ...
  def new_message(aircraft, message)
      when is_struct(message, Message.Adsb.AircraftIdentification) do
    %Adsb.Aircraft{
      aircraft
  ...
  def new_message(aircraft, message) when is_struct(message, Message.AirbornePosition) do
    ...
    |> Map.put(:is_aloft, true)
    |> Map.put(:altitude, message.altitude)
  end
  ...
  defp handle_position(aircraft, pos_message)
    ...
    %Adsb.Aircraft{aircraft | last_position_message: pos_message}
  end
